...
png('C:/Users/Robin/Desktop/LoRaWAN/Latency1.png',width = 300, height = 300, units = "px", bg = "white")

# plot the possible values of probability (0 to 1) against the ordered data 
# notice the option type = '' for plotting the functions

plot(data.ordered, (1:n)/n, type = 'o', ylim = c(0, 1), xlab = 'RSSI(dBm, 50)', ylab = 'CDF', main = 'Empirical Cumluative Distribution')
