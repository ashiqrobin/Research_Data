...
#data_1
plot(data.ordered, (1:n)/n, type = 's',do.points=F, ylim = c(0, 1), xlab = 'Throughput', ylab = 'CDF',add=TRUE)

plot(data.ordered_1, (1:m)/m, type = 's',do.points=F,col="red", ylim = c(0, 1),add=TRUE)
